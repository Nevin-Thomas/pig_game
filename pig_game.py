...
while True:
    ...
    if players.isdigit(): #tells us if it is digit or not
        ...
        print("Invalid, try again.") #is the input is not a digit
...
winning_idx = player_scores.index(max_score)  #gives us the index (which player) of where the max score is
